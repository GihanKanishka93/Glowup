...
<body>
    <div class="receipt">
        ...
        <center>
            <p>{{ now()->setTimezone('Asia/Colombo') }}</p>
        </center>
        <hr>
        <div class="content">
            ...
            <table class="content-items">
                <tbody>
                    <tr>
                        <td width="100%">
                            <p><strong>Bill No: {{ $billing_data->billing_id }}</strong> </p>
                        </td>
