        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-4 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold ">Pet Name : {{ $treatment->pet->name }} </h6>
                    ...
                    <div class="card-body">
                        ...
                        <div class="basic-information">
                            <div class="info-row">
                                <div class="col-sm-12 col-xl-6 col-lg-6">
                                    <p><strong>Pet Name:</strong> {{ $treatment->pet->name }}</p>
                                </div>
                                <div class="col-sm-12 col-xl-6 col-lg-6">
                            ...
                            <div class="info-row">
                                <div class="col-xl-6 col-lg-6">
                                    <p><strong>Pet ID:</strong> {{ $treatment->pet->pet_id }}</p>
                                </div>
                                <div class="col-xl-6 col-lg-6">
                            ...
                            <div class="info-row">
                                ...
                                <div class="col-xl-6 col-lg-6">
                        <p><strong>Pet Category:</strong> {{ $treatment->pet->petcategory->name }}</p>
                                </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="vaccination-{{ $vaccination->id }}">
                                            ...
                                            <td>{{ $vaccination->next_vacc_date }}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                        ...
                        <br>
                            ...
                            <div class="basic-information">
                                <div class="info-row">
                                    <div class="col-sm-12 col-xl-6 col-lg-6">
                                        <p><strong>Next Treatment Date:</strong> {{ $treatment->next_clinic_date }}</p>
                                    </div>
                                    <div class="col-sm-12 col-xl-6 col-lg-6">
