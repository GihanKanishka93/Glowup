                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4">
                            ...
                            <div class="bill-history" style="display: none;">
                                <a href="#" target="_blank" class="btn btn-primary btn-icon-split medical-history-btn"
                                    data-template="{{ route('medical-history.show', ['id' => 'PLACEHOLDER']) }}">
                                            ...
                                            <div id="billing-section-patient" class="billing-section">
                                                ...
                                                <div class="panel-body">
                                                    <div class="row g-3 patient-snapshot-grid">
                                                        <x-forms.pet-selector :pets="$patients ?? []"
                                                            column-class="col-12 col-lg-6" id="patient" name="patient"
                                                            required />
                                                        <div class="col-12 col-lg-6">
                                                            ...
                                                            <select name="doctor" id="doctor"
                                                                ...
                                                                @foreach ($doctors as $item)
                                                                    <option value="{{ $item->id }}" @selected(old('doctor', $authenticatedDoctorId) == $item->id)>
                                                                        {{ $item->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="col-12 col-md-4">
                                                            ...
                                                            <textarea class="form-control" id="medical_history"
                                                                ...
                                                                rows="1">{{ old('medical_history') }}</textarea>
                                                        </div>
                                                        <div class="col-12 col-md-4">
                                                ...
                                                <div class="row g-3 patient-snapshot-grid">
                                                    <x-forms.owner-contact id="contact" name="contact"
                                                        :value="old('contact')" column-class="col-12 col-lg-6" />
                                                    <x-forms.owner-contact id="whatsapp" name="whatsapp"
                                                        label="WhatsApp Number" :value="old('whatsapp', '+94 ')"
                                                        placeholder="+94 7X XXX XXXX" column-class="col-12 col-lg-6" />
                                                    <div class="col-12 col-lg-6">
                                                        ...
                                                        <div class="row g-2 align-items-center prescription-row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <select name="drug_name[]"
                                                                    class="select2 form-select drug_items @error('drug_name') is-invalid @enderror"
                                                                    style="width: 100%">
                                                                    <option value=""></option>
                                                                    @foreach ($drugs as $item)
                                                                        <option value="{{ $item->name }}"
                                                                            @selected(old('drug_name') == $item->name)>
                                                                            {{ $item->name }} @if($item->unit)
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <select name="dosage[]"
                                                                    class="select2 form-select dosage_types @error('dosage') is-invalid @enderror"
                                                                    style="width: 100%">
                                                                    <option value=""></option>
                                                                    @foreach ($dosagetypes as $item)
                                                                        <option value="{{ $item->name }}"
                                                                            @selected(old('dosage') == $item->name)>
                                                                            {{ $item->name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="col-md-2">
                                                                ...
                                                                <select name="dose[]"
                                                                    class="select2 form-select duration_types @error('dose') is-invalid @enderror"
                                                                    style="width: 100%">
                                                                    <option value=""></option>
                                                                    @foreach ($dose as $item)
                                                                        <option value="{{ $item->name }}"
                                                                            @selected(old('dose') == $item->name)>
                                                                            {{ $item->name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="col-md-2">
                                                                ...
                                                                <select name="duration[]"
                                                                    class="select2 form-select duration_types @error('duration') is-invalid @enderror"
                                                                    style="width: 100%">
                                                                    <option value=""></option>
                                                                    @foreach ($durationtypes as $item)
                                                                        <option value="{{ $item->name }}"
                                                                            @selected(old('duration') == $item->name)>
                                                                            {{ $item->name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            @foreach ($durationweeks as $item)
                                                                <label class="radio-button">
                                                                    <input type="radio" name="next_treatment_weeks"
                                                                        value="{{ $item->name }}"
                                                                        @checked(old('next_treatment_weeks') == $item->name)>
                                                                    <span>{{ $item->name }}</span>
                                                                </label>
                                                            @endforeach
                                                        </div>
                                                        ...
                                                        <div class="row g-3 align-items-center service-row">
                                                            <div class="col-md-4">
                                                                <select name="service_name[]" id="service_name"
                                                                    class="select2 form-select service_item @error('service_name') is-invalid @enderror">
                                                                    <option value=""></option>
                                                                    @foreach ($services as $item)
                                                                        <option value="{{ $item->id }}"
                                                                            @selected(old('service_name') == $item->id)>
                                                                            {{ $item->name }} @if($item->unit)
                                                                                [{{ (float) $item->stock_quantity }}
                                                                            {{ $item->unit }}] @endif
                                                                        </option>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (savePatientDetailsBtn) {
            savePatientDetailsBtn.addEventListener('click', function () {
                ...
                fetch("{{ route('billing.save-client-details') }}", {
                    method: 'POST',
                    headers: {
