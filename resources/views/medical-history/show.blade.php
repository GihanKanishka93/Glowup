...
@section('content')
    <div class="container medical-history">
        ...
        <div class="basic-information">
            <p><strong>Client ID:</strong> {{ $patient->patient_id }}</p>
            <p><strong>Client Name:</strong> {{ $patient->name }}</p>
        </div>

        <div class="basic-information" style="display: block;">
            <p><strong>Medical History:</strong> {{ $patient->basic_ilness ?: 'None' }}</p>
            <p><strong>Surgical History:</strong> {{ $patient->surgical_history ?: 'None' }}</p>
            <p><strong>Allergies:</strong> {{ $patient->allegics ?: 'None' }}</p>
        </div>
            ...
            @foreach ($treatments as $treatment)
                <div class="treatment">
                    ...
                    <div class="treatment-details">
                        <p class="trement-basic"><strong>Doctor Name:</strong> <span>{{ $treatment->doctor->name }} </span>
                            <strong> Bill ID:</strong> <span>{{ $treatment->bill->billing_id }}</span> <strong> Bill
                                Date:</strong> <span>{{ $treatment->bill->billing_date }}</span> <strong> Billing
                                Amount:</strong> <span>{{ $treatment->bill->total }}</span>
                        </p>
