                    ...
                    <div class="row no-gutters align-items-stretch">
                        <div class="col-lg-5 d-none d-lg-flex login-visual">
                            <div class="login-visual-overlay">
                                <img src="{{ asset('img/Glowup_Logo-modified.png') }}" alt="Glowup Skin Clinic" class="login-logo mb-4">
                                ...
                                <form class="user" action="{{ url('/login') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <input type="text" name="user_name" value="{{ old('user_name') }}" class="form-control login-control @error('user_name') is-invalid @enderror" id="loginUserName" placeholder="Your username">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <input type="password" name="password" class="form-control login-control @error('password') is-invalid @enderror" id="loginPassword" placeholder="Your password">
                                        </div>
                                    </div>
