...
<h1 class="h3 mb-2 text-gray-800">Edit Skin Concern</h1>
    <div class="row">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="dropdown no-arrow show">
                        <a href="{{ route('pet-breed.index') }}" class="btn btn-sm btn-info btn-icon-split">
                ...
                <form method="post" action="{{ route('pet-breed.update',$petBreed->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control   @error('name') is-invalid @enderror" id="name"
                                        name="name" value="{{ old('name',$petBreed->name) }}" placeholder="Name">
                                    @error('name')
