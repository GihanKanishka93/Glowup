                ...
                <form method="post" action="{{ route('users.update',$user->id) }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="roles[]" id="roles" class="form-control multipel select2 @error('roles') is-invalid @enderror" multiple onchange="getUserRole();">
