...
<h1 class="h3 mb-2 text-gray-800">Add Vaccine</h1>
    <div class="row">
            ...
            <div class="card shadow mb-4">
                ...
                <form action="{{ route('vaccination.store') }}" method="post">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-sm-8">
                                        <select name="petcategory[]" id="petcategory" class="form-control multipel select2" multiple >
                                            ...
                                            @foreach ($petcategory as $item)
                                                <option value="{{ $item->id }}" {{ in_array($item->id, old('petcategory', [])) ? 'selected' : '' }}>
                                                    {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2">Vaccine Duration: </label>
                            <div class="col-sm-8">
