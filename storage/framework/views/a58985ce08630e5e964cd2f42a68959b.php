            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <a href="<?php echo e(route('doctor.index')); ?>" class="btn btn-outline-primary btn-sm">
                            <i class="fas fa-arrow-left me-1"></i> Back
                        </a>
                        <div class="d-flex align-items-center gap-3 flex-wrap">
                            <span class="badge bg-secondary">
                                Joined <?php echo e(optional($doctor->created_at)->format('d M Y') ?? '—'); ?>

                            </span>
                            <span class="badge bg-info text-dark">
                                Last Active <?php echo e($lastActiveDate?->diffForHumans() ?? 'No treatments yet'); ?>
                                ...
                                <div class="card h-100 border-0 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        <dl class="row mb-0 small">
                                            ...
                                            <dd class="col-7 fw-semibold text-uppercase"><?php echo e($doctor->doctor_id); ?></dd>

                                            <dt class="col-5 text-muted">Name</dt>
                                            <dd class="col-7 fw-semibold"><?php echo e($doctor->name); ?></dd>

                                            <dt class="col-5 text-muted">Gender</dt>
                                            <dd class="col-7 text-capitalize"><?php echo e($doctor->gender == 1 ? 'Male' : 'Female'); ?>

                                            </dd>

                                            <dt class="col-5 text-muted">Designation</dt>
                                            <dd class="col-7"><?php echo e($doctor->designation ?? '—'); ?></dd>
                                ...
                                <div class="card h-100 border-0 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        <dl class="row mb-0 small">
                                            ...
                                            <dd class="col-7"><?php echo e($doctor->contact_no ?? '—'); ?></dd>

                                            <dt class="col-5 text-muted">Email</dt>
                                            <dd class="col-7"><?php echo e($doctor->email ?? '—'); ?></dd>

                                            <dt class="col-5 text-muted">Address</dt>
                                            <dd class="col-7"><?php echo e($doctor->address ?? '—'); ?></dd>
                                        </dl>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card h-100 border-0 shadow-sm">
                                    <div
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('doctor-edit')): ?>
                                    ...
                                    <div class="card-body small">
                                        <ul class="list-unstyled mb-3">
                                            <li class="d-flex justify-content-between mb-2">
                                                ...
                                                <strong><?php echo e($patientsServed); ?></strong>
                                            </li>
                                            <li class="d-flex justify-content-between mb-2">
                                                <span class="text-muted">Total treatments</span>
                                                <strong><?php echo e($totalTreatments); ?></strong>
                                            </li>
                                            <li class="d-flex justify-content-between mb-2">
                                            ...
                                            <li class="d-flex justify-content-between">
                                                ...
                                                <strong><?php echo e($nextFollowUpDate?->format('d M Y') ?? 'None scheduled'); ?></strong>
                                            </li>
                                        </ul>
                                        <?php if($nextFollowUpPet): ?>
                                            <div class="alert alert-info py-2 px-3 mb-0">
                                                <small class="d-block"><strong><?php echo e($nextFollowUpPet); ?></strong></small>
            ...
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('billing.index', ['search' => $doctor->doctor_id])); ?>"
                            ...
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $treatments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $treatment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td><?php echo e($treatment->formatted_treatment_date ?? '—'); ?></td>
                                            <td><?php echo e(optional($treatment->patient)->name ?? '—'); ?></td>
                                            <td><?php echo e($treatment->history_complaint ?: '—'); ?></td>
                                            <td><?php echo e($treatment->formatted_next_visit ?? '—'); ?></td>
                                            <td>
                                                <?php if($treatment->bill): ?>
                                                    <?php echo e(optional($treatment->bill)->bill_no ?? '—'); ?>
                                            ...
                                            <td class="text-end">
                                                <?php if($treatment->bill): ?>
                                                    <a href="<?php echo e(route('billing.show', $treatment->bill->id)); ?>"
                                                        class="btn btn-outline-primary btn-sm">
                                                        <i class="fas fa-receipt me-1"></i>Bill
                                                    </a>
                                                <?php endif; ?>
                                                <?php if($treatment->patient_id): ?>
                                                    <a href="<?php echo e(route('patient.show', $treatment->patient_id)); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/gihan.finsbury/Downloads/Vet-APP/Glowup/resources/views/doctor/show.blade.php ENDPATH**/ ?>