                    ...
                    <div class="row no-gutters align-items-stretch">
                        <div class="col-lg-5 d-none d-lg-flex login-visual">
                            <div class="login-visual-overlay">
                                <img src="<?php echo e(asset('img/Glowup_Logo-modified.png')); ?>" alt="Glowup Skin Clinic" class="login-logo mb-4">
                                ...
                                <ul class="login-highlights list-unstyled mt-4 mb-0">
                                    <li><i class="fas fa-calendar-check mr-2"></i>Streamlined check-ins and appointments</li>
                                    <li><i class="fas fa-heartbeat mr-2"></i>Treatment plans and progress in one place</li>
                        ...
                        <div class="col-lg-7">
                            <div class="p-5 login-form">
                                ...
                                <form class="user" action="<?php echo e(url('/login')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <?php if($errors->any()): ?>
                                        <div class="alert alert-dismissible alert-danger">
                                            <button type="button" class="close" data-dismiss="alert">&times;</button>
                                            <span class="font-weight-bold">Login error:</span> Please check your username and password.
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <input type="text" name="user_name" value="<?php echo e(old('user_name')); ?>" class="form-control login-control <?php $__errorArgs = ['user_name'];
...
unset($__errorArgs, $__bag); ?>" id="loginUserName" placeholder="Your username">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <input type="password" name="password" class="form-control login-control <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="loginPassword" placeholder="Your password">
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                        ...
                                        <a class="small text-left" href="<?php echo e(route('password.request')); ?>">Forgot password?</a>
                                    </div>
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/gihan.finsbury/Downloads/Vet-APP/Glowup/resources/views/auth/login.blade.php ENDPATH**/ ?>