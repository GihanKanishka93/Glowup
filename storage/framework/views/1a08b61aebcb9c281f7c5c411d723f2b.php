...
<body>
    <div class="receipt">
            ...
            <tr>
                <td width="90px" class="text-center">
                    <div class="bg-primary p-2 m-2">
                        <img src="<?php echo e(public_path('img/Glowup_Logo.jpg')); ?>" alt="Glowup Skin Clinic" width="90px" height="auto">
                    </div>
                </td>
        ...
        <center><p><?php echo e(now()->setTimezone('Asia/Colombo')); ?></p></center>
        <hr>
        <div class="content">
            ...
            <table class="content-items">
                <tbody>
                    <tr>
                        <td width="100%"><p><strong>Bill No: <?php echo e($billing_data->billing_id); ?></strong> </p></td>

                    </tr>
                    <tr>
                        <td width="100%"><p><strong>Client ID:</strong> <?php echo e($pet->pet_id ?? ''); ?> </p></td>
                    </tr>
                    <tr>
                        <td width="100%"><p><strong>Client Name:</strong> <?php echo e($pet->name ?? 'N/A'); ?></p></td>
                    </tr>
                    <tr>
                        <td width="100%"><p><strong>Doctor:</strong> <?php echo e($doctor->name ?? 'N/A'); ?></p></td>
                    </tr>
                </tbody>
            </table>
                ...
                <table class="content-items">
                    <tbody>
                        <tr>
                            ...
                            <td width="70px" style="text-align: right;"><h4><?php echo e($billing_data->net_amount); ?></h4></td>
                        </tr>
                        <tr>
                            <td width="160px"> <h4>Discount: </h4></td>
                            <td width="40px"> <h4>Rs. </h4></td>
                            <td width="70px" style="text-align: right;"><h4><?php echo e($billing_data->discount); ?></h4></td>
                        </tr>
                        <tr>
                            <td width="160px"> <h4>Total Cost: </h4></td>
                            <td width="40px"> <h4>Rs. </h4></td>
                            <td width="70px" style="text-align: right;"><h4><?php echo e($billing_data->total); ?></h4></td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
<?php /**PATH /Users/gihan.finsbury/Downloads/Vet-APP/Glowup/resources/views/pdf.blade.php ENDPATH**/ ?>