    ...
    <li class="sidebar-modern">
        <div class="sidebar-top">
            <div class="sidebar-brand-wrapper">
                <a class="sidebar-brand" href="<?php echo e(route('home')); ?>" aria-label="Navigate to home">
        ...
        <div class="sidebar-nav">
            <?php $__currentLoopData = $navSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sectionIndex => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="sidebar-section">
                    <p class="sidebar-section-label"><?php echo e($section['label']); ?></p>
                        ...
                        <?php $__currentLoopData = $section['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(isset($item['children'])): ?>
                                ...
                                <li class="sidebar-node">
                                    <button class="sidebar-link has-children <?php echo e($isOpen ? '' : 'collapsed'); ?>" type="button"
                                        ...
                                        <span class="sidebar-icon"><i class="<?php echo e($item['icon'] ?? 'fas fa-circle'); ?>"></i></span>
                                        <span class="sidebar-label"><?php echo e($item['label']); ?></span>
                                        <?php if($hasBadge): ?>
                                            <span
                                                class="sidebar-badge badge-<?php echo e($item['badge_context'] ?? 'neutral'); ?>"><?php echo e(number_format($item['badge'])); ?></span>
                                        <?php endif; ?>
                                        <span class="sidebar-caret"><i class="fas fa-chevron-right"></i></span>
                                    </button>
                                    <div id="<?php echo e($collapseId); ?>" class="collapse sidebar-submenu <?php echo e($isOpen ? 'show' : ''); ?>"
                                            ...
                                            <?php $__currentLoopData = $item['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <li>
                                                    <a href="<?php echo e($child['route']); ?>"
                                                        class="sidebar-sublink <?php echo e(!empty($child['active']) ? 'active' : ''); ?>"
                                                        data-nav-item data-label="<?php echo e($child['label']); ?>"
                                                        data-href="<?php echo e($child['route']); ?>"
                                                        data-icon="<?php echo e($item['icon'] ?? 'fas fa-circle'); ?>">
                                                        <span><?php echo e($child['label']); ?></span>
                                                        <?php if(!empty($child['active'])): ?>
                            ...
                            <?php else: ?>
                                ...
                                <li>
                                    <a href="<?php echo e($item['route']); ?>"
                                        class="sidebar-link <?php echo e(!empty($item['active']) ? 'active' : ''); ?>" data-nav-item
                                        data-label="<?php echo e($item['label']); ?>" data-href="<?php echo e($item['route']); ?>"
                                        data-icon="<?php echo e($item['icon'] ?? 'fas fa-circle'); ?>">
                                        <span class="sidebar-icon"><i class="<?php echo e($item['icon'] ?? 'fas fa-circle'); ?>"></i></span>
                                        <span class="sidebar-label"><?php echo e($item['label']); ?></span>
        ...
        <div class="sidebar-footer">
            ...
            <div class="sidebar-account-card">
                <button class="sidebar-account-toggle dropdown-toggle" type="button" data-bs-toggle="dropdown"
                    aria-expanded="false" data-current-status="<?php echo e($currentStatusKey); ?>">
                    <img class="avatar" src="<?php echo e(asset('img/undraw_profile.svg')); ?>" alt="<?php echo e($userName); ?>">
                    <div class="sidebar-account-copy">
                        <span class="sidebar-account-name"><?php echo e($userName); ?></span>
                        <span class="sidebar-account-role"><?php echo e($user->designation ?? 'Team Member'); ?></span>
                        <span class="sidebar-account-status status-<?php echo e($currentStatusKey); ?>"><i
                                class="fas fa-circle"></i><span
                                class="user-status-label"><?php echo e($currentStatusLabel); ?></span></span>
                    </div>
                ...
                <ul class="dropdown-menu sidebar-account-menu">
                    ...
                    <?php $__currentLoopData = $statusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <button type="button"
                                class="dropdown-item d-flex align-items-center user-status-option <?php echo e($value === $currentStatusKey ? 'active' : ''); ?>"
                                data-status="<?php echo e($value); ?>" data-label="<?php echo e($label); ?>">
                                <span class="status-indicator <?php echo e($value); ?>"></span><?php echo e($label); ?>
                    ...
                    <li><a class="dropdown-item" href="<?php echo e(route('users.profile')); ?>"><i
...
<?php $__env->startPush('scripts'); ?>
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const paletteItems = <?php echo json_encode($commandPaletteItems, 15, 512) ?>;
