<?php $currentTheme = auth()->user()?->theme ?? 'light'; ?>
<nav class="navbar navbar-expand navbar-light compact-topbar sticky-top px-3 align-items-center gap-3">
    ...
    <form class="global-search d-none d-md-flex align-items-center flex-grow-0"
        ...
        <input type="search" name="search" id="global-search-input" class="form-control"
            placeholder="Search patient, mobile, bill ID" value="<?php echo e(request('search')); ?>" aria-label="Global search">
    </form>
    ...
    <div class="ms-auto d-flex align-items-center gap-2">
        ...
        <button type="button" class="btn theme-toggle" data-theme="<?php echo e($currentTheme); ?>" aria-label="Toggle theme">
            <i class="fas <?php echo e($currentTheme === 'dark' ? 'fa-moon' : 'fa-sun'); ?>"></i>
        </button>
    </div>
</nav>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="GET" action="<?php echo e(route('billing.index')); ?>">
                    <div class="input-group">
                        <span class="input-group-text"><i class="fas fa-search"></i></span>
                        <input type="search" name="search" class="form-control"
                            placeholder="Search patient, mobile, bill ID" value="<?php echo e(request('search')); ?>">
