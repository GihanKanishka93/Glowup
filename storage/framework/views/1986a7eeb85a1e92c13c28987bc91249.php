...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(request()->getBasePath()); ?>/plugin/fontawesome-free/css/v4-shims.min.css" />
    ...
    <style>
        ...
        body.theme-dark {
            ...
            --info-hover: #0EA5E9;
            --info-contrast: #0C0A07;
            --shadow-sm: 0 20px 40px rgba(0, 0, 0, 0.45);
            --field-bg: #1E2533;
        ...
        body.theme-dark {
            ...
            background-image: radial-gradient(circle at 10% 20%, rgba(212, 175, 55, 0.07) 0%, transparent 40%),
                radial-gradient(circle at 90% 10%, rgba(99, 102, 241, 0.06) 0%, transparent 35%),
                radial-gradient(circle at 50% 80%, rgba(13, 148, 136, 0.05) 0%, transparent 45%),
                linear-gradient(135deg, #0F111A 0%, #161B26 60%, #1F2633 100%);
        ...
        .sidebar-account .status-pill.status-available {
            background: rgba(34, 197, 94, 0.28);
        }

        .sidebar-account .status-pill.status-in_consult {
            background: rgba(245, 158, 11, 0.32);
        }

        .sidebar-account .status-pill.status-offline {
...
<body id="page-top" class="theme-<?php echo e($activeTheme); ?>">
    <section id="loading">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (themeToggle) {
                themeToggle.addEventListener('click', function () {
                    ...
                    const request = csrfToken ? fetch('<?php echo e(route('ui.theme')); ?>', {
                        method: 'POST',
                        headers: {
            ...
            statusButtons.forEach(function (button) {
                button.addEventListener('click', function (event) {
                    ...
                    fetch('<?php echo e(route('ui.status')); ?>', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': csrfToken,
