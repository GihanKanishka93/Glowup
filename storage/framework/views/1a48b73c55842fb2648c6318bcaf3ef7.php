    ...
    <div class="dashboard-container container-fluid">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                ...
                <p class="text-muted mb-0">Operational overview for <?php echo e(now()->format('l, jS F Y')); ?></p>
            </div>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <h3 class="text-dark fw-bold mb-0"><?php echo e(number_format($stats['totalPatients'] ?? 0)); ?></h3>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <h3 class="text-dark fw-bold mb-0">Rs <?php echo e(number_format($stats['todayRevenue'] ?? 0, 0)); ?>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <h3 class="text-dark fw-bold mb-0"><?php echo e(number_format($stats['todayConsultations'] ?? 0)); ?>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <h3 class="text-dark fw-bold mb-0"><?php echo e(number_format($stats['newPatientsToday'] ?? 0)); ?></h3>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-0">
                        <?php if(count($recentActivity) > 0): ?>
                            <div class="list-group list-group-flush">
                                <?php $__currentLoopData = $recentActivity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                ...
                                                <div>
                                                    <h6 class="mb-1 text-dark fw-bold">
                                                        <?php echo e($bill->treatment->patient->name ?? 'Unknown Patient'); ?></h6>
                                                    <span class="text-muted small">
                                                        Bill #<?php echo e($bill->billing_id); ?> • <?php echo e($bill->created_at->diffForHumans()); ?>

                                                    </span>
                                                </div>
                                            </div>
                                            <div class="text-end">
                                                <h6 class="mb-0 text-dark fw-bold">Rs <?php echo e(number_format($bill->total, 2)); ?></h6>
                                                <span
                                                    class="badge <?php echo e($bill->payment_status == 1 ? 'bg-success-subtle text-success' : 'bg-warning-subtle text-warning'); ?> rounded-pill small">
                                                    <?php echo e($bill->payment_status == 1 ? 'Paid' : 'Unpaid'); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/gihan.finsbury/Downloads/Vet-APP/Glowup/resources/views/home.blade.php ENDPATH**/ ?>