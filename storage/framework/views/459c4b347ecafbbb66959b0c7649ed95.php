...
unset($__errorArgs, $__bag); ?>" id="first_name"
                                    name="first_name" value="<?php echo e($user->first_name); ?>" placeholder="First Name">
...
unset($__errorArgs, $__bag); ?>" id="last_name"
                                    name="last_name"  value="<?php echo e($user->last_name); ?>" placeholder="Last Name">
...
unset($__errorArgs, $__bag); ?>" id="email"
                                    name="email" value="<?php echo e($user->email); ?>" placeholder="Email">
...
unset($__errorArgs, $__bag); ?>" id="contact_number"
                                    name="contact_number"  value="<?php echo e($user->contact_number); ?>" placeholder="Contact Number">
...
unset($__errorArgs, $__bag); ?>" id="designation"
                                  name="designation"  placeholder="Designation" value="<?php echo e($user->designation); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                    id="user_name" name="user_name" value="<?php echo e($user->user_name); ?>" placeholder="User name">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="roles[]" id="roles" class="form-control multipel select2 <?php $__errorArgs = ['roles'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" multiple onchange="getUserRole();">
                                    ...
                                    <?php $__currentLoopData = $role; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->name); ?>"  <?php if(in_array($item->id, $userRoles)): ?> <?php if(true): echo 'selected'; endif; ?>   <?php endif; ?>  ><?php echo e($item->name); ?></option>
                            ...
                            <div class="col-sm-8">
                                <select name="doc_id" id="doc_id" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $doctor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->id); ?>" <?php if($item->id == $user->doc_id ): ?> <?php if(true): echo 'selected'; endif; ?>   <?php endif; ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/gihan.finsbury/Downloads/Vet-APP/Glowup/resources/views/settings/user/edit.blade.php ENDPATH**/ ?>