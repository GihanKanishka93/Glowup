...
unset($__errorArgs, $__bag); ?>"
                                    id="name" name="name" value="<?php echo e(old('name')); ?>" placeholder="Name">
                                        ...
                                        <div class="col-md-4 form-check">
                                            <label class="label label-defalt">
                                                <input class="form-check-input" type="checkbox" name="permission[]" id=""
                                                    value="<?php echo e($value->name); ?>" class="<?php $__errorArgs = ['permission'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/gihan.finsbury/Downloads/Vet-APP/Glowup/resources/views/settings/role/create.blade.php ENDPATH**/ ?>