            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="dropdown no-arrow show">
                        <a href="<?php echo e(route('services.index')); ?>" class="btn btn-sm btn-info btn-icon-split">
...
unset($__errorArgs, $__bag); ?>" id="name"
                                    name="name" value="<?php echo e(old('name', $service->name)); ?>" placeholder="Name">
...
unset($__errorArgs, $__bag); ?>" id="price"
                                    name="price" value="<?php echo e(old('price', $service->price)); ?>" placeholder="0.00"
...
unset($__errorArgs, $__bag); ?>" id="stock_quantity"
                                    name="stock_quantity"
                                    value="<?php echo e(old('stock_quantity', (float) $service->stock_quantity)); ?>" placeholder="0.00">
...
unset($__errorArgs, $__bag); ?>" id="unit"
                                    name="unit" value="<?php echo e(old('unit', $service->unit)); ?>"
...
unset($__errorArgs, $__bag); ?>" id="min_stock_level"
                                    ...
                                    value="<?php echo e(old('min_stock_level', (float) $service->min_stock_level)); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/gihan.finsbury/Downloads/Vet-APP/Glowup/resources/views/settings/services/edit.blade.php ENDPATH**/ ?>