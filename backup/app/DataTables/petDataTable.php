...
class PetDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($item) {
                $user = Auth()->user();
                $btn = '';
                $btn .= '<a class="btn btn-info btn-circle btn-sm" href="' . route('pet.show', $item->id) . '" data-bs-toggle="tooltip" title="View Pet">'
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('pet_id')->visible(true)->title('petID')->searchable(true),
            ...
            Column::make('owner_name')->data('owner_name')->title('Owner Name')->searchable(true)->orderable(false),
            //  Column::make('')
