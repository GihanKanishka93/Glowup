...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse {{  (request()->is('billing*')) ? 'show' : ''   }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-primary-color py-2 collapse-inner rounded">
                @can('bill-create')    <a class="collapse-item {{ request()->routeIs('billing.create') ? 'active' : '' }}" href="{{ route('billing.create') }}">New Bill</a>@endcan
                @can('bill-list')      <a class="collapse-item {{ request()->routeIs('billing.index') ? 'active' : '' }}" href="{{ route('billing.index') }}">List Bills</a> @endcan
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse {{  (request()->is('doctor*')) ? 'show' : ''   }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-primary-color py-2 collapse-inner rounded">
    ...
    <li class="nav-item">
        ...
        <div id="collapseFour" class="collapse {{  (request()->is('settings/*')) ? 'show' : ''   }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-primary-color py-2 collapse-inner rounded">
                ...
                @can('drug-list')       <a class="collapse-item {{ request()->routeIs('drug.*') ? 'active' : '' }}" href="{{ route('drug.index') }}">Drog Management</a> @endcan
                @can('services-list')       <a class="collapse-item {{ request()->routeIs('services.*') ? 'active' : '' }}" href="{{ route('services.index') }}">Services </a> @endcan
