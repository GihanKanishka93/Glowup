            ...
            <div class="card shadow mb-4">
                ...
                <form action="{{ route('billing.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col">
                                <label class="col-sm-10" for="pet-category">Pet Type/ Category: <i class="text-danger">*</i></label>
                            <div class="col-sm-10">
                            ...
                            <div class="col">
                                <label class="col-sm-10" for="breed">Breed: </label>
                            <div class="col-sm-10">
                            ...
                            <div class="col">
                                <label class="col-sm-10">Gender: <i class="text-danger">*</i></label>
                            <div class="col-sm-10">
                            ...
                            <div class="prescription-details col-md-12">
                                <div class="form-group row">
                                    <div class="col-md-4">
                                        ...
                                        class="select2 form-control drug_name @error('reffered_ward') is-invalid @enderror">
                                        <option value="" selected="selected"></option>
                                        ...
                                        {{-- <input type="text" class="form-control" placeholder="" name="drug_name[]"> --}}
                                    </div>
                                    <div class="col-md-2">
...
document.getElementById('addPrescription').addEventListener('click', function() {
    let prescriptionClone = document.querySelector('.prescription-details').cloneNode(true);

    // Clear input values in the cloned node
    let clonedInputs = prescriptionClone.querySelectorAll('input, select');
    clonedInputs.forEach(function(input) {
        input.value = '';
    });
    ...
    // Remove the plus button and add the delete button in the cloned row
    let buttonContainer = prescriptionClone.querySelector('.form-group.row');
    let plusButton = buttonContainer.querySelector('.btn.btn-sm.text-white.btn-icon-split');
    if (plusButton) {
        plusButton.replaceWith(removeButton);
    }
    ...
    // Add click event listener to the remove button
    removeButton.addEventListener('click', function() {
        prescriptionClone.remove();
    });

    document.getElementById('prescription').appendChild(prescriptionClone);
});
});
