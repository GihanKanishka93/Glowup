        ...
        <div class="col-xl-12 col-lg-12">
            ...
            <form id="dateRangeForm" class="row">
                ...
                <div class="col-md-2">
                    @php  $date = date('Y-m-d');
                    @endphp
                <input type="text" id="start_date" name="start_date" value="{{ old('start_date',$date) }}" class="datepicker form-control">
            </div>
                <label for="end_date" class="col-md-2">End Date:</label>
                <div class="col-md-2">
                <input type="text" id="end_date" name="end_date" value="{{ old('end_date',$date) }}" class="datepicker form-control">
            </div>
    ...
    $(document).ready(function () {
        ...
        var dataTable = $('#myTable').DataTable({
            ...
            ajax: {
                ...
                data: function (d) {
                    // Add additional parameters for the server-side processing
