...
<h1 class="h3 mb-2 text-gray-800">Edit {{ $doctor->name }}</h1>
{{-- @if($errors->any())
                ...
                <form method="post" action="{{ route('doctor.update',$doctor->id) }}">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-sm-2">DoctorID: <i class="text-danger">*</i></label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control @error('doctor_id') is-invalid @enderror" id="doctor_id" name="doctor_id"
                                value="{{ $doctor->doctor_id }}" @cannot('doctorid-edit') readonly @endcannot>
                                @error('doctor_id')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control   @error('name') is-invalid @enderror" id="name"
                                    name="name" value="{{ $doctor->name }}" placeholder="Name">
                                @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="gender" id="gender" class="form-control  @error('gender') is-invalid @enderror">
                                    <option value=""></option>
                                    <option value="1" @if($doctor->gender == 1) @selected(true) @endif  >Male</option>
                                    <option value="2" @if($doctor->gender == 2) @selected(true) @endif >Female</option>
                                </select>
                                @error('gender')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2" for="owner_name">Designation: </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control   @error('designation') is-invalid @enderror" id="designation"
                                name="designation" value="{{ $doctor->designation }}" placeholder="">
                                @error('designation')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                name="address" value="{{ $doctor->address }}" placeholder="">
                                @error('address')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2" for="contactno">Contact Number: </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control   @error('contactno') is-invalid @enderror" id="contactno"
                                name="contactno" value="{{ $doctor->contact_no }}" placeholder=" ">
                                @error('contactno')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                name="email" value="{{ $doctor->email }}" placeholder=" ">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
