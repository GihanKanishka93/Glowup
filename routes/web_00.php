...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/home', [App\Http\Controllers\BillingController::class, 'create'])->name('home');
    Route::get('/', [App\Http\Controllers\BillingController::class, 'create'])->name('billing.create');
    ...
    Route::prefix('reports')->group(function () {
        ...
        Route::post('/reports/admission-chart-data', [reportController::class, 'getAdmissionData'])->name('reports.admissionChartData');
