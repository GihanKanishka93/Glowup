...
class DailyVisitPatientController extends Controller
{
    ...
    {
        return view('patient.daily-visit.create', compact('patient'));
    }
    ...
    {
        return view('patient.daily-visit.edit', compact('patient', 'visit'));
    }
    ...
    public function update(Patient $patient, Request $request, $visit)
    {
        ...
        return redirect()->route('visit.create', $patient->id)->with('message', 'Counselor Note updated');
    }
    ...
    {
        $visit->delete();
        return redirect()->route('visit.create', $patient->id)->with('message', 'Counselor Note deleted');
    }
